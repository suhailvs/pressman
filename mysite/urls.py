...
urlpatterns = [
    ...
    path('pickup/<int:pk>/finish/', views.mark_pickup_finished, name='mark_pickup_finished'),
    ...
    path("pickups/<int:pk>/add-items/", views.add_pickup_items_page, name="add_pickup_items_page"), # just renders a django template page 
